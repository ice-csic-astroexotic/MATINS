*** SUPPLEMENT TO eos14.f FOR THE CASE OF ARBITRARY MAGNETIC FIELD
*
*             EQUATION OF STATE FOR ELECTRON-ION PLASMAS
*
*                 USES SUBROUTINES FROM eos14.f
*
* A.Y.Potekhin & G.Chabrier, A&A 550, A43 (2013)
* Please send comments to Alexander Potekhin: palex@astro.ioffe.ru
* Last update 12.12.14
* Stems from eosmag12.f v.08.02.13.
* Difference - upgrade of EOSFIM12 to EOSFIM14
...
* EOSFIM14 - non-ideal parts of thermodynamic functions in magn.field.
...
ccc     *  DENS,GAMI,CHI,TPT,LIQSOL,PnkT,UNkT,SNk,CV,CHIR,CHIT)
*                                                       Version 06.07.12
...
* NB: zero-point term is not included.
      ...
      subroutine EOSFIM14(LIQSOL,CMI,Zion,RS,TEMP,GAMAG,KWK,KDIR,
     *  FC1,UC1,PC1,SC1,CV1,PDT1,PDR1,
     *  FC2,UC2,PC2,SC2,CV2,PDT2,PDR2)
*                                                       Version 12.12.14
* Stems from EOSFIM12 v.03.06.12
* Difference: redundant input GAMI is excluded
...
*   mixture, S_{mix}/(N_i k) HAS TO BE ADDED EXTERNALLY.
      ...
      if (LIQSOL.ne.1.and.LIQSOL.ne.0) stop'EOSFIM14: invalid LIQSOL'
      if (CMI.le..1) stop'EOSFIM14: too small CMI'
      if (Zion.le..1) stop'EOSFIM14: too small Zion'
      if (RS.le..0) stop'EOSFIM14: invalid RS'
      if (TEMP.le..0) stop'EOSFIM14: invalid TEMP'
      GAME=1.d0/RS/TEMP ! electron Coulomb parameter Gamma_e
      GAMI=Zion**1.666667d0*GAME ! effective Gamma_i - ion Coul.param.
