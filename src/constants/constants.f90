...
module constants
  ...
  real*8, parameter :: MASS_N = 1.674927471d-24      ! baryon (neutron) mass [g]
  real*8, parameter :: MASS_N_MEV = 939.565560d0     ! neutron mass [MeV]
  real*8, parameter :: MASS_E_MEV = 0.511d0          ! electron mass [MeV]
  ...
  real*8, parameter :: UNIT_E = UNIT_B*UNIT_R/(1.d6*T_YEAR*CLIGHT) ! Units of electric field [statVolt = G]
  real*8, parameter :: UNIT_JOULE = UNIT_B**2*UNIT_R**3/(1d40*4d0*PI*1d6*T_YEAR)  ! Joule heating density units [10^40 erg/(km^3*s)]
